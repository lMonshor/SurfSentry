...
class uiWidget(QWidget):
    ...
    def initUI(self):
        ...
        self.control_title_label = QtWidgets.QLabel(self)
        self.control_title_label.setGeometry(QtCore.QRect(73, 50, 180, 84))
        self.control_title_label.setText("")
        self.control_title_label.setPixmap(QtGui.QPixmap("project/assets/control_logo.png"))
        self.control_title_label.setScaledContents(True)
        self.control_title_label.setWordWrap(False)
        ...
        self.bottom_widget.setStyleSheet("background-color:rgb(41, 49, 50)")
