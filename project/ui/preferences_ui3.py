...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        single_right_icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..\\assets', 'single_right_logo.png')
        double_right_icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..\\assets', 'double_right_logo.png')
        single_left_icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..\\assets', 'single_left_logo.png')
        double_left_icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..\\assets', 'double_left_logo.png')
        add_icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..\\assets', 'add_logo.png')
        trash_icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..\\assets', 'trash_logo.png')
...
"                            }")
        ...
        self.bd_unblocked_list_title.setGeometry(QtCore.QRect(457, 30, 153, 24))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(14)
        font.setBold(False)
...
"}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(single_right_icon_path), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(double_right_icon_path), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(single_left_icon_path), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(double_left_icon_path), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(add_icon_path), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(trash_icon_path), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        self.ab_first_desc_text = QtWidgets.QPlainTextEdit(parent=self.about_page)
...
"color:white;\n"
"border:none;")
        self.ab_first_desc_text.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.ab_first_desc_text.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.ab_first_desc_text.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustIgnored)
...
"color:white;\n"
"border:none;")
        self.ab_second_text.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.ab_second_text.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.ab_second_text.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustIgnored)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ab_first_desc_text.setPlainText(_translate("MainWindow", "Surfsentry is a Windows application developed to protect users against malicious websites. It retrieves a list of malicious links from USOM (Ulusal Siber Olaylara Müdahale Merkezi - National Cyber Incident Response Center) and writes them to the hosts file. This ensures a secure internet experience for users.\n"
"\n"
""))
        self.ab_main_title.setText(_translate("MainWindow", "SurfSentry"))
        self.ab_second_title.setText(_translate("MainWindow", "Blocking CNC Server IPs"))
        self.ab_second_text.setPlainText(_translate("MainWindow", "Surfsentry not only blocks domain connections by writing them to the hosts file, but also identifies IP addresses associated with Command and Control (CNC) servers provided by USOM. It adds firewall rules to block communication with these IPs, providing an additional layer of protection against malicious activity."))
