...
if __name__ == '__main__':
    ...
    my_pref_ui = preferences_ui.uiPreferences(
        my_information_ui=my_information_ui, my_loading_ui=my_loading_ui)

    my_menu_ui = menu_ui.uiMenu(my_pref_ui=my_pref_ui)

    my_widget_ui = widget_ui.uiWidget(
        my_tray_app_ui=my_tray_app_ui, my_information_ui=my_information_ui,
        my_loading_ui=my_loading_ui, my_menu_ui=my_menu_ui, my_pref_ui=my_pref_ui)
    ...
    my_update_data_worker.finished.connect(my_pref_ui.fillMalList)
    my_update_data_worker.finished.connect(my_pref_ui.fillBlockedList)
